...
const DE = {
  ...
  'tut.provida.safe': 'Gut — die Messung wurde abgebrochen',
  'tut.provida.lost': 'Gut — die Streife kann den Abstand nicht halten',
  'tut.provida.freed': 'Die Beschränkung endet — die Messung ist hinfällig',
  ...
  'tut.free.body': 'Das durchgestrichene Schild beendet alle Streckenverbote. Es gilt kein festes Tempolimit mehr — Verkehr, Sicht und Strecke zählen trotzdem.',
...
const EN = {
  ...
  'tut.provida.safe': 'Good — the measurement was aborted',
  'tut.provida.lost': 'Good — the patrol cannot hold the gap',
  'tut.provida.freed': 'The restriction ended — the measurement is void',
  ...
  'tut.free.body': 'The crossed-out sign ends all route restrictions. There is no fixed speed limit now — traffic, visibility and road conditions still matter.',
