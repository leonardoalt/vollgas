...
export const SECTIONS = [
  { km:  0.0, name:'Stuttgart-Zuffenhausen',   sub:'Porsche-Werk · Autobahnkreuz', limit:100, biome:BIOME.URBAN,    curve:0.9, exit:'Zuffenhausen' },
  { km:  2.2, name:'Stuttgart-Feuerbach',      sub:'Ausfahrt 21',                  limit:120, biome:BIOME.URBAN,    curve:1.0 },
  { km:  3.8, name:'Engelbergbasistunnel',     sub:'Leonberg · Tunnelstrecke',     limit:100, biome:BIOME.URBAN,    curve:0.25, tunnel:true },
  { km:  6.0, name:'Leonberg',                 sub:'Ausfahrt 20',                  limit:120, biome:BIOME.VINEYARD, curve:1.1, exit:'Leonberg' },
  { km:  8.2, name:'Sindelfingen-Ost',         sub:'Mercedes-Benz Werk',           limit:120, biome:BIOME.URBAN,    curve:0.8, exit:'Sindelfingen' },
  { km: 10.6, name:'Böblingen-Hulb',           sub:'Ende aller Streckenverbote',   limit:null, biome:BIOME.FARM,    curve:0.6 },
  { km: 14.0, name:'Herrenberg',               sub:'Freie Fahrt · Gäu',            limit:null, biome:BIOME.FARM,    curve:0.5, exit:'Herrenberg' },
  { km: 18.2, name:'Rottenburg · Neckartal',   sub:'Richtgeschwindigkeit 130',     limit:null, advice:true, biome:BIOME.VINEYARD, curve:1.4 },
  { km: 21.2, name:'Horb am Neckar',           sub:'Kurvige Talstrecke',           limit:120, biome:BIOME.FOREST,   curve:1.9, exit:'Horb' },
  { km: 23.6, name:'Empfingen',                sub:'Baustelle · verengte Fahrbahn',limit: 80, biome:BIOME.FOREST,   curve:0.7, works:true },
  { km: 26.2, name:'Oberndorf am Neckar',      sub:'Ende aller Streckenverbote',   limit:null, biome:BIOME.FOREST,  curve:1.2, exit:'Oberndorf' },
  { km: 28.6, name:'Raststätte Neckarburg',    sub:'Tank & Rast · Neckartalbrücke',limit:null, biome:BIOME.FOREST,  curve:0.8, rest:true },
  { km: 31.0, name:'Rottweil',                 sub:'thyssenkrupp Testturm',        limit:null, biome:BIOME.ALB,     curve:0.7, tower:true, exit:'Rottweil' },
  { km: 34.0, name:'Villingen-Schwenningen',   sub:'Baar-Hochfläche',              limit:120, biome:BIOME.ALB,      curve:1.0, exit:'VS-Mitte' },
  { km: 36.4, name:'Geisingen',                sub:'Ende aller Streckenverbote',   limit:null, biome:BIOME.ALB,     curve:0.9 },
  { km: 39.2, name:'Engen · Hegau',            sub:'Vulkankegel',                  limit:120, biome:BIOME.HEGAU,    curve:1.3, exit:'Engen' },
  { km: 41.0, name:'Singen (Bodensee)',        sub:'Zielgerade',                   limit:100, biome:BIOME.HEGAU,    curve:0.8 },
];
